...
<head>
    ...
    <title>Game <?=$genre?> - HiGamer</title>
</head>
<body>
    <div id="container">
                    ...
                    echo ' 
                        <div class="section">
                            ...
                            <div class="section-title">
                                    <h1><span style="color: white">Game</span> '.$genre.'</h1> 
                            </div>
                        </div>
                        <div class="game-list">';

                            $sql = 'SELECT DISTINCT HangHoa.MSHH, HangHoa.Gia, HangHoa.thumbnail FROM HangHoa INNER JOIN LoaiHangHoa ON HangHoa.MaLoaiHang = "'.$id.'"';
